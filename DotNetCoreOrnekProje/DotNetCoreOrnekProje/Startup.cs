...
namespace StudentApplication.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationContext>(opts => opts.UseSqlServer(Configuration["ConnectionStrings:StudentApplicationDB"]));
            //services.AddSingleton(typeof(IDataRepository<Student, long>), typeof(StudentManager));
            services.AddTransient(typeof(IDataRepository<Student, long>), typeof(StudentManager));
